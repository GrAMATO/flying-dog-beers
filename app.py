...
app.layout = html.Div([ 
  ...
  html.Div([            
        ...
        'backgroundColor': 'rgb(22, 26, 40)', 'padding-top':'50px', 'padding-bottom':'100px', 'padding-right':'10px', 'padding-left':'10px', 'display': 'inline-block', 'vertical-align': 'bottom','color':'rgb(246, 185, 53)'}),
